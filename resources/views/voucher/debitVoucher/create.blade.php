...
<section id="multiple-column-form">
    <div class="row match-height">
        <div class="col-12">
            <div class="card">
                <div class="card-tabs">
                    <a class="card-tab active" href="{{route(currentUser().'.debit.create')}}">Add New</a>
                    <a class="card-tab " href="{{route(currentUser().'.debit.index')}}">List</a>
                </div>
                <h4 class="card-title text-center mt-5">{{__('Debit Voucher Entry')}}</h4>
