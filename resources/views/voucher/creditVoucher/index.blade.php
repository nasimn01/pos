@extends('layout.app')
@section('pageTitle',trans('Credit Voucher List'))
    ...
    <div class="row" id="table-bordered">
        <div class="col-12">
            <div class="card">
                ...
                @endif
                <div class="card-tabs">
                    <a class="card-tab " href="{{route(currentUser().'.credit.create')}}">Add New</a>
                    <a class="card-tab active" href="{{route(currentUser().'.credit.index')}}">List</a>
                </div>
